 ...
 * 
 */
public class GenericDoubleValueState extends GenericValueState
{
    /**
     * @param handler
     * @param parentState
     ...
     * @pre method.getParameterTypes()[0].getName() == "java.lang.Double"
     */
    public GenericDoubleValueState(
