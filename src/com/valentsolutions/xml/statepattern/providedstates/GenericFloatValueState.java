 ...
 * 
 */
public class GenericFloatValueState extends GenericValueState
{
    /**
     * @param handler
     * @param parentState
     ...
     * @pre method.getParameterTypes()[0].getName() == "java.lang.Float"
     */
    public GenericFloatValueState(
