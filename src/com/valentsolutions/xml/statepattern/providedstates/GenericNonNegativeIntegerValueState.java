 ...
 * 
 */
public class GenericNonNegativeIntegerValueState extends GenericLongValueState
{
     ...
     * @param method
     */
    public GenericNonNegativeIntegerValueState(
        ...
        throws ConversionException
    {
        ...
        {
            throw new ConversionException(value + " is outside of the accepted range for nonNegativeInteger");
        }
