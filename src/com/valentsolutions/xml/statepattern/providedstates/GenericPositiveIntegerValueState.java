 ...
 * 
 */
public class GenericPositiveIntegerValueState extends GenericLongValueState
{
     ...
     * @param method
     */
    public GenericPositiveIntegerValueState(
        ...
        throws ConversionException
    {
        ...
        {
            throw new ConversionException(value + " is outside of the accepted range for positiveInteger");
        }
